...
window.CodeMirror = (function() {
  ...
  function updateSelectionRange(cm) {
    ...
    function add(left, top, width, bottom, newline) {
      if (top < 0) top = 0;
      var className = newline ? "CodeMirror-selected CodeMirror-selected-newline" : "CodeMirror-selected"; 
    ...
    function drawForLine(line, fromArg, toArg, retTop) {
      ...
      if (drawNewline) {
        toArg = lineObj.text.length;
        var newLinePos = coords(toArg);
        if (toArg === 0) {
          add(newLinePos.left, newLinePos.top, newLineWidth, newLinePos.bottom, true);
        } else {
          add(newLinePos.left, newLinePos.top, newLineWidth, newLinePos.bottom, true);
        }
      }
