...
(function(mod) {
  ...
  function updateSelectionRange(cm, range, output) {
    ...
    function add(left, top, width, bottom) {
      if (top < 0) top = 0;
      top = Math.round(top); // fix safari sigle pixel gap selection drawing problem due to incorrect rounding
      bottom = Math.round(bottom); // fix safari sigle pixel gap selection drawing problem due to incorrect rounding
