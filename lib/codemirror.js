...
(function(mod) {
  ...
  function Display(place, doc) {
    ...
    d.dropIndicatorDiv = elt("div", null, "CodeMirror-dropIndicator");
  ...
  function registerEventHandlers(cm) {
    ...
    function drag_(e) {
      ...
      if (pos) {
        var dropIndicator = cm.display.dropIndicatorDiv;
        var coords = cursorCoords(cm, pos, "div");
        dropIndicator.style.left = coords.left + "px";
        dropIndicator.style.top = coords.top + "px";
        dropIndicator.style.height = Math.max(0, coords.bottom - coords.top) * cm.options.cursorHeight + "px";
        if (!dropIndicator.parentNode) {
          cm.display.lineSpace.appendChild(dropIndicator);
        }
      }
    }

    function dragLeave_(e) {
      removeDragIndicator(cm);
    }
    ...
    if (cm.options.dragDrop) {
      ...
      on(d.scroller, "dragleave", dragLeave_);
  ...
  function removeDragIndicator(cm) {
      var dropIndicator = cm.display.dropIndicatorDiv;
      if (dropIndicator.parentNode) {
  ...
  function buildLineContent(cm, lineView) {
    ...
    signal(cm, "renderLine", cm, lineView.line, builder.pre, builder);
    return builder;
  }
