...
window.CodeMirror = (function() {
  ...
  function updateSelectionRange(cm) {
    ...
    var newLineWidth = charWidth(display);
    ...
    function drawForLine(line, fromArg, toArg, retTop) {
      ...
      if (drawNewline) {
        ...
        add(newLinePos.left, newLinePos.top, newLineWidth, newLinePos.bottom);
        add(newLinePos.left, newLinePos.top, newLineWidth, newLinePos.bottom, 'selected-newline');
      }
      ...
      iterateBidiSections(getOrder(lineObj), fromArg || 0, toArg == null ? lineLen : toArg, function(from, to, dir) {
        ...
        while (nextSpaceIndex >= fromArg && nextSpaceIndex < toArg) {
          var tabPos = coords(nextSpaceIndex);
          add(tabPos.left, tabPos.top, tabPos.right - tabPos.left, tabPos.bottom, 'selected-space');
